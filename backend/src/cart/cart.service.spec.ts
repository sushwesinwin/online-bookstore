        ...
        await fc.assert(
          fc.asyncProperty(
            ...
            async testData => {
              ...
              expect((result as any).book.price.toNumber()).toBe(
                testData.bookPrice,
              );
            },
          ),
          ...
          fc.asyncProperty(
            ...
            async testData => {
              ...
              if (testData.newQuantity <= testData.inventory) {
                ...
                expect(
                  mockPrismaService.cartItem.update,
        ...
        await fc.assert(
          fc.asyncProperty(
            ...
            async testData => {
              ...
              const mockCartItems = Array.from(cartState.entries()).map(
                ([bookId, data]) => ({
                  id: 'cart-item-' + bookId,
                  userId: testData.userId,
                  bookId: bookId,
