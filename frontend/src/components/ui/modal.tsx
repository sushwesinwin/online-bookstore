...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-full sm:max-w-md lg:max-w-lg bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200 max-h-[90vh] sm:max-h-[85vh]">
