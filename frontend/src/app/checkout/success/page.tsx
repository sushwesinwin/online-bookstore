    ...
    const fulfill = async () => {
      try {
        ...
        const msg =
          ...
          'Something went wrong verifying your order.';
        setError(msg);
        setIsProcessing(false);
      }
    };
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-12 text-center border border-[#E4E9E8]">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div
                  className={`relative rounded-full p-8 shadow-xl ${error ? 'bg-red-500' : 'bg-[#0B7C6B]'}`}
                >
                  {error ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Link href="/orders">
                    <Button
                      size="lg"
                      className="w-full bg-[#0B7C6B] hover:bg-[#0D8F7A] shadow-xl transition-all h-14 text-lg font-bold"
                    >
                  ...
                  <Link href="/books">
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full h-14 text-lg font-bold border-[#E4E9E8]"
                    >
                      Browse Books
              ...
              <>
                ...
                {sessionId && (
                  <div className="bg-[#F4F8F8] rounded-2xl p-4 mb-8 border border-[#E4E9E8]">
                    <p className="text-xs font-bold text-[#848785] uppercase tracking-wider mb-2">
                      Transaction Reference
                    </p>
                    <p className="text-sm font-mono text-[#101313] break-all">
                      {sessionId}
                    </p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Link href="/orders">
                    <Button
                      size="lg"
                      className="w-full bg-[#0B7C6B] hover:bg-[#0D8F7A] shadow-xl hover:shadow-2xl transition-all h-14 text-lg font-bold"
                    >
                      <Package className="mr-2 h-5 w-5" />
                      My Orders
                    </Button>
                ...
                {!isProcessing && (
                  <div className="mt-12 pt-8 border-t border-[#E4E9E8]">
                    <div className="flex items-center justify-center gap-2 text-sm font-medium text-[#848785]">
                      ...
                      <span>
                        Taking you to your orders in {countdown} seconds...
                      </span>
                    </div>
                  </div>
                )}
