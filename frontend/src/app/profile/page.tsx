                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        <Link href="/orders">
                            <div className="bg-white rounded-2xl border border-[#E4E9E8] p-5 flex items-center justify-between hover:border-[#0B7C6B]/50 hover:shadow-md transition-all cursor-pointer group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-semibold text-[#101313] text-sm">My Orders</span>
                                </div>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-semibold text-[#101313] text-sm">Security</span>
                            </div>
                            <ChevronRight className="h-4 w-4 text-[#848785] group-hover:text-[#0B7C6B] transition-colors" />
                        </button>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-semibold text-[#101313] text-sm">Sign Out</span>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#E4E9E8] overflow-hidden shadow-sm">
                        ...
                        {activeTab === 'profile' && (
                            <form onSubmit={handleProfileSubmit} className="p-8 space-y-6">
                                <div>
                                    <h2 className="text-lg font-bold text-[#101313]">Personal Information</h2>
                                    <p className="text-sm text-[#848785] mt-1">Update your name below.</p>
                                </div>
                                ...
                                {updateProfileError && (
                                    <div className="flex items-center gap-3 p-4 bg-red-50 text-red-700 rounded-xl border border-red-200 text-sm">
                                        ...
                                        {(updateProfileError as any)?.response?.data?.message || 'Failed to update profile.'}
                                    </div>
                                )}

                                {/* Email (read-only) */}
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-[#101313]">Email Address</label>
                                    ...
                                    <p className="text-xs text-[#848785]">Email cannot be changed.</p>
                                </div>
                        ...
                        {activeTab === 'security' && (
                            <form onSubmit={handlePasswordSubmit} className="p-8 space-y-6">
                                <div>
                                    <h2 className="text-lg font-bold text-[#101313]">Change Password</h2>
                                ...
                                {/* Current Password */}
                                <div className="space-y-2">
                                    <label htmlFor="currentPassword" className="text-sm font-medium text-[#101313]">
                                        Current Password
                                    </label>
                                    <div className="relative">
