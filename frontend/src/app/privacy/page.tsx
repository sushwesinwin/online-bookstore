        ...
        <div className="prose prose-lg max-w-none space-y-6 text-[#101313]">
          ...
          <section>
            ...
            <p className="text-[#848785] leading-relaxed">
              ...
              compliant payment processor. We do not store your complete credit
              card information on our servers. Payment data is encrypted and
              transmitted securely using industry-standard SSL/TLS protocols.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#848785] leading-relaxed">
              ...
              settings, but disabling them may affect website functionality.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#848785] leading-relaxed">
              ...
              longer retention period is required by law. Order history is
          ...
          <section>
            ...
            <p className="text-[#848785] leading-relaxed">
              ...
              your personal information, please contact our privacy team through
