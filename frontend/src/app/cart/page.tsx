            ...
            <main className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        {isEmpty ? 'Your cart is empty' : `${cart.itemCount} item${cart.itemCount !== 1 ? 's' : ''} in your cart`}
                    </p>
                </div>
                            ...
                            {cart.items.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 mb-4">{item.book.category}</p>
                                        ...
                                        <div className="flex items-center gap-4 flex-wrap">
                                            <div className="flex items-center border border-gray-300 rounded-lg">
                                                ...
                                                <button
                                                    onClick={() => handleQuantityChange(item.id, item.quantity, 1)}
                                                    className="px-3 py-2 hover:bg-gray-100 transition-colors disabled:opacity-50"
                                                    disabled={isUpdating || item.quantity >= item.book.inventory}
                                                >
