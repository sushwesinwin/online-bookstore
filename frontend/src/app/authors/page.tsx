...
const authors = [
    ...
    },
    {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/F_Scott_Fitzgerald_1921.jpg/440px-F_Scott_Fitzgerald_1921.jpg',
    ...
    },
    {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/L.N.Tolstoy_Prokudin-Gorsky.jpg/440px-L.N.Tolstoy_Prokudin-Gorsky.jpg',
    ...
    },
    {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Gabriel_Garcia_Marquez.jpg/440px-Gabriel_Garcia_Marquez.jpg',
        bio: 'Nobel Prize winning author',
                    ...
                    <div className="container mx-auto">
                        {filteredAuthors.length === 0 ? (
                            <div className="text-center py-16">
                                ...
                                <h3 className="text-xl font-semibold text-[#101313] mb-2">No authors found</h3>
                                <p className="text-[#848785]">Try adjusting your search or filters</p>
                            </div>
                        ) : (
                                    ...
                                    <div key={index} className="group bg-white rounded-xl p-6 border border-[#E4E9E8] hover:shadow-xl transition-all duration-300">
                                        ...
                                        <div className="text-center space-y-2">
                                            ...
                                            <div className="pt-3 border-t border-[#E4E9E8] mt-3">
                                                <p className="text-xs font-semibold text-[#101313] mb-2">Famous Works:</p>
                                                <div className="flex flex-wrap gap-1 justify-center">
                                                    {author.famousWorks.slice(0, 2).map((work, i) => (
                                                        <span key={i} className="text-xs bg-[#F4F8F8] text-[#848785] px-2 py-1 rounded">
                                                            {work}
                                                        </span>
                                                    ))}
                                                </div>
                ...
                <section className="py-16 px-4 bg-linear-to-br from-[#0B7C6B] to-[#17BD8D]">
                    <div className="container mx-auto text-center">
                        <div className="max-w-2xl mx-auto space-y-6">
                            ...
                            <p className="text-lg text-white/90">
                                We're constantly adding new authors and books to our collection
                            </p>
                            <Link href="/books">
                                <Button size="lg" variant="secondary" className="bg-white text-[#0B7C6B] hover:bg-white/90">
                                    Browse All Books
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><Link href="/authors" className="hover:text-[#0B7C6B] transition-colors">Authors</Link></li>
                            </ul>
                        </div>
