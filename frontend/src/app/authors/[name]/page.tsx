...
const AUTHORS_DATA: Record<string, {
    ...
    'Stephen King': {
        ...
        awards: ['Bram Stoker Award', 'World Fantasy Award', 'British Fantasy Society Award'],
    ...
    'J.K. Rowling': {
        ...
        famousWorks: ['Harry Potter Series', 'The Casual Vacancy', 'Cormoran Strike Series'],
    },
    'Agatha Christie': {
        ...
        famousWorks: ['Murder on the Orient Express', 'And Then There Were None', 'The Murder of Roger Ackroyd'],
    },
    'Ernest Hemingway': {
    ...
    'Agatha Christie': {
        name: 'Agatha Christie',
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Agatha_Christie.png/440px-Agatha_Christie.png',
        bio: 'Dame Agatha Mary Clarissa Christie was an English writer known for her 66 detective novels and 14 short story collections, particularly those revolving around fictional detectives Hercule Poirot and Miss Marple. She is the best-selling fiction writer of all time, with her novels having sold over two billion copies.',
        birthYear: '1890-1976',
        nationality: 'British',
        genres: ['Mystery', 'Crime Fiction', 'Detective Fiction', 'Thriller'],
        ...
        return (
            <div className="min-h-screen">
                ...
                <div className="container mx-auto py-20 px-4 text-center">
                    ...
                    <p className="text-gray-600 mb-8">We couldn't find information about this author.</p>
                    <Link href="/">
            ...
            <main className="container mx-auto py-8 px-4">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-12">
                    <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className="p-12">
                            <div className="mb-6">
                                <span className="text-sm text-indigo-600 font-semibold uppercase tracking-wide">About Author</span>
                                <h1 className="text-4xl font-bold mt-2 mb-4">{authorData.name}</h1>
                            ...
                            {/* Bio */}
                            <p className="text-gray-700 leading-relaxed mb-8">{authorData.bio}</p>
                            ...
                            <div className="grid grid-cols-3 gap-6 mb-8 pb-8 border-b">
                                ...
                                <div className="text-center">
                                    <div className="text-3xl font-bold text-indigo-600 mb-1">4.5</div>
                            ...
                            <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl p-6 text-white">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-lg mb-2">Explore {authorData.name.split(' ')[0]}'s Collection</h3>
                                        <p className="text-indigo-100 text-sm mb-4">
                                            Discover all available books by this renowned author in our collection.
                                        </p>
                ...
                <div className="mb-8">
                    <h2 className="text-3xl font-bold mb-6">
                        ...
                        {booksData && <span className="text-gray-500 text-xl ml-3">({booksData.meta.total})</span>}
                    </h2>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center py-12 bg-gray-50 rounded-lg">
                            ...
                            <p className="text-gray-600">No books found by this author in our collection.</p>
                            <p className="text-sm text-gray-500 mt-2">Check back later for new additions!</p>
                        </div>
                    )}
                </div>
            </main>
