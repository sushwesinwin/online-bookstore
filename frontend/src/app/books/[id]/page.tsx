        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main>
                ...
                <div className="bg-white border-b">
                    <div className="container mx-auto px-4 py-4">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>/</span>
                            <Link href={`/books?category=${book.category}`} className="hover:text-indigo-600">{book.category}</Link>
                            <span>/</span>
                ...
                <div className="container mx-auto px-4 py-8">
                    <Link href="/books" className="inline-flex items-center text-gray-600 hover:text-indigo-600 mb-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 mb-16">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-xl text-gray-600">
                                by <span className="text-indigo-600 font-semibold hover:underline cursor-pointer">{book.author}</span>
                            </p>
                            ...
                            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100">
                                ...
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div className="flex items-center border border-gray-300 rounded-lg">
                                        ...
                                        <button
                                            onClick={() => setQuantity(Math.min(book.inventory, quantity + 1))}
                                            className="px-4 py-2 hover:bg-gray-100 transition-colors"
                        ...
                        <div className="prose max-w-none">
                            {selectedTab === 'description' && (
                                <div className="space-y-4">
                                    <p className="text-gray-700 leading-relaxed text-lg">
                                        {book.description || 'Discover this captivating book that takes you on an unforgettable journey. With masterful storytelling and rich character development, this work stands as a testament to literary excellence.'}
                                    </p>
                                    <p className="text-gray-700 leading-relaxed">
                                        Perfect for readers who appreciate depth, nuance, and compelling narratives that stay with you long after the final page.
                                    </p>
                                </div>
                            )}
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between py-3 border-b">
                                            ...
                                            <span className="text-gray-600">{formatPrice(book.price)}</span>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="flex justify-between py-3 border-b">
                            ...
                            {selectedTab === 'reviews' && (
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6">
                                        <div className="flex items-center gap-8">
                                            <div className="text-center">
                                                <div className="text-5xl font-bold text-indigo-600 mb-2">{rating}</div>
                                    ...
                                    {/* Individual Reviews */}
                                    {[
                                        { name: 'Sarah Johnson', rating: 5, date: '2 days ago', comment: 'Absolutely loved this book! The storytelling is masterful and kept me engaged from start to finish.' },
                                        { name: 'Michael Chen', rating: 5, date: '1 week ago', comment: 'One of the best books I\'ve read this year. Highly recommend to anyone who enjoys this genre.' },
                                        { name: 'Emma Williams', rating: 4, date: '2 weeks ago', comment: 'Great read overall. Some parts were a bit slow, but the ending made up for it.' }
                                    ].map((review, index) => (
                                ...
                                <Link key={i} href={`/books/${i}`} className="group">
                                    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-lg font-bold text-indigo-600">$19.99</p>
                                        </div>
                                    </div>
                                </Link>
                            ))}
