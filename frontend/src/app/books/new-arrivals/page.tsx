                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Latest books added to our collection</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-indigo-100">
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            <div className="relative">
                                ...
                                <img
                                    src={data.data[0].imageUrl || 'https://covers.openlibrary.org/b/id/12668456-L.jpg'}
                            ...
                            <div className="flex-1">
                                ...
                                <h2 className="text-3xl font-bold mb-2">{data.data[0].title}</h2>
                                <p className="text-xl text-gray-600 mb-4">{data.data[0].author}</p>
                                <p className="text-gray-700 mb-6 line-clamp-3">
                                    {data.data[0].description || 'A captivating new release you won\'t want to miss. Discover this latest addition to our collection.'}
                                </p>
                                <div className="flex items-center gap-4">
                                    <span className="text-3xl font-bold text-indigo-600">{formatPrice(Number(data.data[0].price))}</span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                            {data.data.map((book, index) => (
                                <div key={book.id} className="relative">
                                    ...
                                    {index === 0 && params.page === 1 && <div className="hidden" />}
                                </div>
                            ))}
                        </div>
