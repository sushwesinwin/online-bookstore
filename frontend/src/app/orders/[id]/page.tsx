    ...
    return (
      <div className="min-h-screen bg-[#F9FCFB]">
        ...
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <h1 className="text-3xl font-bold text-[#101313] mb-4">
            Order Not Found
          </h1>
          <p className="text-[#848785] mb-8 max-w-md mx-auto">
            Sorry, we couldn&apos;t find the order you&apos;re looking for. It
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            <Link
              href="/orders"
              className="inline-flex items-center text-sm font-semibold text-[#848785] hover:text-[#0B7C6B] transition-colors group"
            >
          ...
          <div className="bg-white rounded-3xl border border-[#E4E9E8] shadow-sm overflow-hidden mb-8">
            <div className="p-8 border-b border-[#E4E9E8] flex flex-wrap items-center justify-between gap-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold text-[#101313]">
                    Order {order.orderNumber}
                  </h1>
                  <div
                    className={`flex items-center gap-2 px-4 py-1.5 rounded-full border ${status.color}`}
                  >
            ...
            <div className="bg-[#F4F8F8]/50 p-8 border-b border-[#E4E9E8]">
              <div className="grid md:grid-cols-4 gap-8">
                <div className="flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${order.status !== 'CANCELLED' ? 'bg-[#0B7C6B] text-white shadow-lg' : 'bg-red-100 text-red-600'}`}
                  >
                    <Clock className="h-5 w-5" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-[#848785] uppercase tracking-wider">
                      Placed
                    </div>
            ...
            <div className="grid lg:grid-cols-3">
              <div className="lg:col-span-2 p-8 border-r border-[#E4E9E8]">
                ...
                <div className="space-y-6">
                  {order.items.map(item => (
                    <div
                      key={item.id}
                      className="flex gap-6 pb-6 border-b border-[#F4F8F8] last:border-0 last:pb-0"
                    >
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-sm text-[#848785] font-medium">
                          by {item.book.author}
                        </p>
                        <div className="flex items-center gap-4 pt-2">
                          <Badge
                            variant="secondary"
                            className="bg-[#F4F8F8] text-[#101313] border-none"
                          >
                            Qty: {item.quantity}
                          </Badge>
              ...
              <div className="bg-[#F4F8F8]/30 p-8 space-y-8">
                {/* Summary */}
                <div>
                  <h3 className="text-lg font-bold text-[#101313] mb-6">
                    Payment Summary
                  </h3>
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-[#E4E9E8] flex justify-between items-center">
                      <span className="text-lg font-bold text-[#101313]">
                        Total
                      </span>
                      <span className="text-2xl font-bold text-[#0B7C6B]">
                        {formatPrice(order.totalAmount)}
                      </span>
                    </div>
                  </div>
          ...
          <div className="bg-[#E4FFFB] rounded-2xl p-6 flex items-center justify-between gap-6 border border-[#0B7C6B]/10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-[#101313]">
