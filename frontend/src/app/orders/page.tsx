      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            <div>
              <h1 className="text-4xl font-bold text-[#101313] mb-2">
                My Orders
              </h1>
          ...
          {isLoading ? (
            <div className="space-y-6">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl border border-[#E4E9E8] p-6 animate-pulse"
                >
            ...
            <div className="bg-white rounded-3xl border border-[#E4E9E8] p-20 text-center shadow-sm">
              ...
              <h2 className="text-2xl font-bold text-[#101313] mb-3">
                No orders yet
              </h2>
              <p className="text-[#848785] mb-8 max-w-sm mx-auto">
                You haven&apos;t made any purchases yet. Your future orders will
                appear here.
              </p>
              <Link href="/books">
                <Button
                  size="lg"
                  className="bg-[#0B7C6B] hover:bg-[#0D8F7A] shadow-xl hover:shadow-2xl transition-all hover:scale-105"
                >
                  Browse Books
                  ...
                  >
                    ...
                    <div className="bg-[#F4F8F8]/50 p-6 border-b border-[#E4E9E8] flex flex-wrap items-center justify-between gap-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="text-sm text-[#848785] font-medium">
                            Order Number
                          </div>
                          <div className="font-bold text-[#101313] tracking-wide">
                            {order.orderNumber}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-6">
                        ...
                        <div className="text-right">
                          ...
                          <div className="font-bold text-[#0B7C6B] text-lg">
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-[#848785]">
                                by {item.book.author} • {item.quantity} copy
                              </p>
                            </div>
                      ...
                      <div className="mt-8 flex items-center justify-between border-t border-[#E4E9E8] pt-6">
                        ...
                        <div className="flex gap-3">
                          <Link href={`/orders/${order.id}`}>
                            <Button
                              variant="outline"
                              className="h-11 px-6 shadow-sm hover:bg-[#F4F8F8] font-semibold"
                            >
                              Order Details
