  ...
  if (!blog) {
    return (
      <div className="min-h-screen bg-[#F8FAFB] py-24 text-center">
        ...
        <p className="text-gray-600 mb-8">This blog post could not be found or has been removed.</p>
        <Link href="/blogs">
          <Button className="bg-[#0B7C6B] hover:bg-[#096B5B]">Return to Blogs</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFB] py-12 px-6">
      <div className="container max-w-4xl mx-auto">
        <Link href="/blogs" className="inline-flex items-center text-sm text-gray-600 hover:text-[#0B7C6B] mb-8 transition-colors">
          ...
          <header className="mb-10 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-700">{blog.author.firstName} {blog.author.lastName}</span>
              </div>
              <div className="flex items-center gap-2">
