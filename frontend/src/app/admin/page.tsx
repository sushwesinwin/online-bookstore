    ...
    <div className="space-y-10">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map(stat => (
          <div
            key={stat.name}
            className="group relative overflow-hidden rounded-2xl border border-[#E4E9E8] bg-white p-6 shadow-sm transition-all hover:shadow-md"
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`flex items-center text-xs font-semibold ${stat.trend === 'up' ? 'text-[#17BD8D]' : 'text-[#FF4E3E]'}`}
              >
                {stat.change}
                {stat.trend === 'up' ? (
            ...
            <div className="mt-4">
              ...
              <h3 className="text-2xl font-bold text-[#101313]">
                {stat.value}
              </h3>
            </div>
          </div>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button className="text-sm font-semibold text-[#0B7C6B] hover:underline">
              View all
            </button>
          </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-[#E4E9E8] bg-[#F8FAFB]">
                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-[#848785]">
                      Order ID
                    </th>
                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-[#848785]">
                      Customer
                ...
                <tbody className="divide-y divide-[#E4E9E8]">
                  {recentOrders.map(order => (
                    <tr
                      key={order.id}
                      className="transition-colors hover:bg-[#F8FAFB]/50"
                    >
                      <td className="whitespace-nowrap px-6 py-4">
                        <span className="font-medium text-[#101313]">
                          {order.id}
                        </span>
                      </td>
                      <td className="whitespace-nowrap px-6 py-4">
            ...
            {[
              {
                ...
                desc: '5 books are low in stock',
                time: '10 mins ago',
                color: '#FF4E3E',
              },
              {
                title: 'New Customer',
                desc: 'Alice Johnson joined BookStore',
                time: '1 hour ago',
                color: '#17BD8D',
              },
              {
                title: 'Review Received',
                desc: 'New 5-star review for "The Hobbit"',
                time: '3 hours ago',
                color: '#F9B959',
              },
              {
                title: 'System Update',
                desc: 'Database maintenance scheduled',
                time: '5 hours ago',
                color: '#101313',
              },
            ].map((notif, i) => (
              <div
                key={i}
                className="flex space-x-4 rounded-2xl border border-[#E4E9E8] bg-white p-4 shadow-sm transition-all hover:translate-x-1"
              >
                <div
