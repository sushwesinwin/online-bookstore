    ...
    <RoleGuard allowedRoles={['ADMIN']}>
      <div className="flex min-h-screen bg-[#F8FAFB]">
          ...
          <div className="flex h-full flex-col">
            <div className="p-8">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold tracking-tight text-[#101313]">
                  BookStore
                </span>
                <span className="rounded bg-[#DFFEF5] px-2 py-0.5 text-[10px] font-bold text-[#17BD8D]">
                  ADMIN
                </span>
              </Link>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      <item.icon
                        className={`mr-3 h-5 w-5 ${isActive ? 'text-white' : 'text-[#848785] group-hover:text-[#101313]'}`}
                      />
                      {item.name}
                    </div>
                    {isActive && (
        ...
        <main className="flex-1 lg:pl-72">
          <div className="min-h-screen p-8 lg:p-12">{children}</div>
        </main>
      </div>
    </RoleGuard>
  );
